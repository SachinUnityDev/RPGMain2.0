    ...
    public void ControlGameState(WoodGameState woodGameState)
    {
        switch (woodGameState)
        {
            case WoodGameState.Running:
                WoodGameService.Instance.gameState = WoodGameState.Running;
            ...
            case WoodGameState.LoadPaused:
                WoodGameService.Instance.gameState = WoodGameState.LoadPaused;

                break;
            case WoodGameState.ExitGame:
                WoodGameService.Instance.gameState = woodGameState;
                ExitGame();
...
//public void OnGameSeqComplete()
//{

//  //  Sequence OnGameOverSeq = DOTween.Sequence();
//  ////  OnGameOverSeq.AppendCallback(() => woodGameView.InGamePopUp("MIS HIT"))
//  //       .AppendInterval(0.4f)
//  //       .AppendCallback(() => WoodGameService.Instance.ControlGameState(WoodGameState.Running));
//  //  OnGameOverSeq.Play();
