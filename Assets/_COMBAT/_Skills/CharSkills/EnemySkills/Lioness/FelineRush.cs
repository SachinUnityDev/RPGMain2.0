...
namespace Combat
{
    public class FelineRush : SkillBase
    {
        private CharNames _charName;
        public override CharNames charName { get => _charName; set => _charName = value; }
        public override SkillNames skillName => SkillNames.FelineRush;
        ...
        {
       str2 = $"-2-6 <style=Fortitude>Fortitude</style>";
