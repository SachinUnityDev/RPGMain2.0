...
namespace Combat
{
...

    {
        ...
        //[SerializeField]List<PerkBaseData> allPerkInSkill;
        //[SerializeField] TextMeshProUGUI skilltxt;
        //[SerializeField] TextMeshProUGUI charNameTxt; 
        //[SerializeField] PerkBaseData currSelectedPerk = null;
        ...
        //{
        //    //foreach (PerkBaseData skillnPerk in allPerkInSkill)
        //    //{
        ...
        //    //PerkBaseData SameLvlPerk = allPerkInSkill.Find(t => t.perkLvl == currSelectedPerk.perkLvl && t != currSelectedPerk);
        //    //SkillService.Instance.SetPerkState(SameLvlPerk.perkName, PerkSelectState.UnClickable);
        //    //List<PerkBaseData> clickedList = allPerkInSkill.Where(t => t.state == PerkSelectState.Clicked).ToList();
        //    //clickedList.ForEach(t => Debug.Log("Clicked perk" + t.perkName)); 
        //    //if (currSelectedPerk.perkLvl + 1 <= SkillLvl.Level3)
        //    //{
        //    //    List<PerkBaseData> clickablePerks = new List<PerkBaseData>(); 
        //    //    List<PerkBaseData> OneLvlUpPerks = allPerkInSkill.Where(t => t.perkLvl == currSelectedPerk.perkLvl + 1).ToList();
        //    //    foreach (PerkBaseData oneLvlUp in OneLvlUpPerks)
        //    //    {
        ...
        //    //                break;
        //    //            }
        //    //            foreach (PerkBaseData clickedData in clickedList)
        //    //            {
        ...
        //    //    List<PerkBaseData> UnclickablePerks = OneLvlUpPerks.Where(t => !clickablePerks
        ...
        //    //        List<PerkBaseData> twoLvlUpPerks = allPerkInSkill.Where(t => t.perkLvl == currSelectedPerk.perkLvl + 2).ToList();
        //    //        List<PerkBaseData> lvl2ClickablePerks = new List<PerkBaseData>(); 
        //    //        foreach (PerkBaseData clickablePerk in clickablePerks)
        //    //        {
        //    //            List<PerkBaseData> tempData = new List<PerkBaseData>(); 
        ...
        //    //        List<PerkBaseData> Lvl2UnclickablePerks = twoLvlUpPerks.Where(t => !lvl2ClickablePerks
        //    //                            .Any(p => p.perkName == t.perkName)).ToList();
