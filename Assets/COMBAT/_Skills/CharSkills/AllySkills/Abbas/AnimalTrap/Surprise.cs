...
//namespace Combat
//{
//    public class Surprise : SkillBase
//    {
...
//        public override List<PerkNames> preReqList => new List<PerkNames>() { PerkNames.EnjoyTrap, PerkNames.HuntingSeason }; 

//        public override string desc => "Surprise";
