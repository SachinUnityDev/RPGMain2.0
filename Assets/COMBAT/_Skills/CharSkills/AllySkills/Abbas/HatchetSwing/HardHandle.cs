...
//namespace Combat
//{
//    public class HardHandle : SkillBase
//    {
...
//        public override List<PerkNames> preReqList => new List<PerkNames>() { PerkNames.DoubleSwing, PerkNames.CutTheKnee };

//        public override string desc => "Hard handle";
