...
namespace Combat
{
    public class Overpower : SkillBase
    {
        private CharNames _charName;
        public override CharNames charName { get => _charName; set => _charName = value; }
        public override SkillNames skillName => SkillNames.Overpower;
        ...
        {
		FirstOnSamelane();   //First on any lane
        }
        ...
        {
       str2 = $"-10-14 <style=Fortitude>Fortitude</style>";
