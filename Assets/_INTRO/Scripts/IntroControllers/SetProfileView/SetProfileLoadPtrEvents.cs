...
namespace Intro
{
    public class SetProfileLoadPtrEvents : MonoBehaviour,  IPointerClickHandler, IPointerEnterHandler, IPointerExitHandler
    {
     ...
     //   [SerializeField] TMP_InputField inputField;
        ...
        [SerializeField] SetProfileLoadView setProfileLoadView;
        ...
        //}
        public void Init(GameModel gameModel, SetProfileLoadView setProfileView) // each profile mapped to one game 
        {
            this.gameModel = gameModel;
            this.setProfileLoadView = setProfileView;
            FillPlankDetails();
        }
        ...
        {
            //if (!isPlankClicked)
            //    setProfileLoadView.SetClickSlot(transform.GetSiblingIndex());
        }
