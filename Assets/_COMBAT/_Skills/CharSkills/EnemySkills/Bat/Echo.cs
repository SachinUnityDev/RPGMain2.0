...
namespace Combat
{
    public class Echo : SkillBase
    {
        private CharNames _charName;
        public override CharNames charName { get => _charName; set => _charName = value; }
        public override SkillNames skillName => SkillNames.Echo;
        ...
        {
    FirstOnSamelane();   //should be ALL enemies
        }
        ...
        {
            str1 = $"80% <style=Pure>Pure Dmg</style>";
        ...
        {
             str3 = "-7-10 <style=Fortitude>Fortitude</style>";
