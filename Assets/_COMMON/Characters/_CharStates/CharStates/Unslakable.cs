...
//        {
//            //if (_statName != StatsName.hunger)
//            //    return;

//            //float maxL = charController.GetStatChanceData(StatsName.hunger).maxLimit;  // i..e 60 
//            //if (charController.GetStat(StatsName.hunger).baseValue < maxL * 0.6f)  // Exit condition 
//            //{
//            //    EndState();
//            //}
